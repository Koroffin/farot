F.define('managers/page', function (PageManager) {
	...
	var _navigate = F.isExists(history) ? navigateHistory : navigateHash;
	...
	Router.prototype.state = function (stateName, fn) {
		...
		this.isStarted && this.checkState(stateName);
		return this;
	}
	...
	Router.prototype.update = function () {
		...
		F.isFunction(fn) ? fn(this.data) : this._overwise(this.data);
	}
