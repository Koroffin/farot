...
public class Sql2oModel {
    ...
    public static class AccountConnector {
        ...
        public static void create (AccountModel model) {
            try (Connection conn = sql2o.beginTransaction()) {
                ...
                conn.createQuery(CREATE_USER_QUERY)
                    ...
                    .addParameter("gold", UserConstants.default_resources.GOLD)
                    .addParameter("gold_per_minute", UserConstants.default_resources.GOLD_PER_MINUTE)
                    .addParameter("wood", UserConstants.default_resources.WOOD)
                    .addParameter("wood_per_minute", UserConstants.default_resources.WOOD_PER_MINUTE)
                    .addParameter("x", UserConstants.default_coordinates.X)
                    .addParameter("y", UserConstants.default_coordinates.Y)
                    .executeUpdate();
