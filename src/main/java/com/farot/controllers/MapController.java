...
public class MapController {
  ...
  public static Object get (Request req, Response res) {
    ...
    try {
      ...
      return new ResponseArrayModel(1, (List<Object>) (Object) Sql2oModel.Map.get(user.x, user.y));
    } catch (Exception e) {
  ...
  public static Object move (Request req, Response res) {
    ...
    try {
      ...
      List<Object> result = (List<Object>) (Object) Sql2oModel.Map.move(body.x, body.y);
      
      user.x = body.x;
      user.y = body.y;
      Sql2oModel.User.update(user);
